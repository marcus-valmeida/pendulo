/**
  ...
  *          A main.c chama apenas Hardware_Init() — o resto fica aqui.
  ******************************************************************************
  */
 ...
 * A main.c e o aeropendulo.c nao precisam saber que existem.
 * -------------------------------------------------------------------------- */
 ...
 * Chama as configuracoes na ordem correta: clock primeiro, perifericos depois.
 * -------------------------------------------------------------------------- */
